...
<head>
  ...
  <title>Ajouter un nouvelle fast food </title>
...
<body>
  ...
  <div class="container">
    <h2 class="text-center mb-4">Ajouter un fast_ food </h2>

    <div class="card shadow">
      <div class="card-body">
        <form action="ajounew_ff.php" method="POST" enctype="multipart/form-data">
          
          <div class="mb-4">
            <label for="name" class="form-label">Nom du fast food </label>
          ...
          <div class="mb-4">
            <label for="image" class="form-label">Image du fast food </label>
