...
<head>
  ...
  <title>SenResto_Escoa - Menu Fast Food</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="menu-header animated" style="animation-delay: 0.5s;">
      <h2>Découvrez notre Menu Fast Food</h2>
      <p>Une sélection de délicieux fast foods pour satisfaire toutes vos envies</p>
    ...
    foreach ($categories as $cat) {
        ...
        $sql = "SELECT * FROM ff_items WHERE categorie = :categorie";
        if ($search != '') {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '        <input type="hidden" name="item_id" value="' . $row['id_ff'] . '">';
  ...
  <footer class="footer">
    <div class="container">
      ...
      <p>Les meilleurs fast foods disponibles à votre porte</p>
