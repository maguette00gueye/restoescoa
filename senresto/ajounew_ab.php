...
// Requête d'insertion
$sql = "INSERT INTO ab_items (name, description, price, categorie, image) VALUES (:name, :description, :price, :categorie, :image)";
...
if ($stmt->execute()) {
    ...
    header("Location: all_ab.php");  // Redirige vers la page principale après l'ajout
    exit;
} else {
