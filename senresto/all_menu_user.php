...
$sqlCategories = "SELECT DISTINCT categorie FROM menu_items";
...
<head>
  ...
  <title>SenResto_Escoa - Menu du Jour</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="menu-header animated" style="animation-delay: 0.5s;">
      <h2>Découvrez notre Menu du Jour</h2>
      <p>Une expérience culinaire authentique avec les saveurs du Sénégal</p>
    ...
    foreach ($categories as $cat) {
        ...
        $sql = "SELECT * FROM menu_items WHERE categorie = :categorie AND date = :today";
        if ($search != '') {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '        <input type="hidden" name="item_id" value="' . $row['id_menu'] . '">';
  ...
  <script>
    ...
    // Fermer la notification d'ajout au panier
