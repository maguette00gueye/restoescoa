...
$sqlCategories = "SELECT DISTINCT categorie FROM menu_items ORDER BY categorie";
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="all_user.php">Utilisateurs</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="menu-header animated" style="animation-delay: 0.5s;">
      ...
      <p>Administration des menus disponibles dans votre restaurant</p>
    ...
    <div class="text-center animated" style="animation-delay: 0.6s;">
      <a href="new_menu.php" class="add-new-btn">
        <i class="fas fa-plus-circle"></i> Ajouter un nouveau menu
      </a>
    </div>
    ...
    foreach ($categoriesToShow as $cat) {
        ...
        $sql = "SELECT * FROM menu_items WHERE categorie = :categorie";
        if ($search != '') {
        ...
        // Vérifier si la catégorie contient des menus
        if ($stmt->rowCount() > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '      <p class="card-meta">Créé le: ' . htmlspecialchars($row['date']) . ' à ' . htmlspecialchars($row['heure']) . '</p>';
                echo '      <div class="action-btns">';
        
                echo '        <form action="modifier_menu.php" method="POST">';
